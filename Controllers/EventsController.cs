...
namespace EventEase1.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            var eventEaseContext = _context.Events.Include(e => e.Venue);
        ...
        // POST: Events/Create
         ...
         {
             Console.WriteLine("🚨 Event POST Create method hit");
             Console.WriteLine($"VenueId: {@event.VenueId}, EventName: {@event.EventName}");
             Console.WriteLine($"VenueId received: {@event.VenueId}");
